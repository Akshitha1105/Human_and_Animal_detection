...
def load_models():
    ...
    detector.load_state_dict(torch.load("C:\\Users\\akshi\\OneDrive\\Desktop\\HUMAN ANIMAL\\detector_finetuned.pth", map_location=device))
    ...
    classifier.load_state_dict(torch.load("C:\\Users\\akshi\\OneDrive\\Desktop\\HUMAN ANIMAL\\classifier_finetuned.pth", map_location=device))
